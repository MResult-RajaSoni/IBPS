...
public class CPC_Maker implements IFormServerEventHandler {

    CommonMethod objCommon = null;
    ReadProperties objRPF = null;

    public CPC_Maker(CommonMethod objCommon, ReadProperties objRPF) {
    ...
    public String executeServerEvent(IFormReference objIForm, String controlName, String eventType, String data) {
        ...
        switch (eventType) {
            ...
            case "Click": {
                switch (controlName) {
                    case "CheckAMLStatus": {
                     objCommon.CheckAMLStatus(objIForm);
                     break;
                    }
                     case "CreateFinnacleAccount": {
                     objCommon.CreateFinnacleAccount(objIForm);
                     break;
                    }
                      case "CheckCKYC": {
